...
\begin{frame}{Motivation}
    \begin{itemize}
        \item \textbf{Goal}: Compute $e^{\tau A}v$ efficiently for large sparse $A$.
    ...
    \begin{block}{Our Work}
        Reproduced convergence plots in MATLAB for key cases.
    \end{block}
\end{frame}
...
\begin{frame}{Results}
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{negative_semidefinite.png}
...
\begin{frame}{Results}
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{skew_Hermitian.png}
...
\begin{frame}{Results}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{figure}
                \includegraphics[width=\textwidth]{Lanczos_negative_semidefinite.png}
